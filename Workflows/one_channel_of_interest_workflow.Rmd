---
title: "one_channel_of_interest_workflow"
...
Download the macros here: https://tinglab.s3.amazonaws.com/ImageCombine.ijm, https://tinglab.s3.amazonaws.com/ChannelMeasure.ijm, https://tinglab.s3.amazonaws.com/ROIAnnotationOverlay.ijm
...
Second, install the segmentation models that I trained here: https://tinglab.s3.amazonaws.com/2D_segmentation_model, https://tinglab.s3.amazonaws.com/3D_segmentation_model. Just let them remain in your downloads folder.
...
Now, run the following in the terminal to run the macro:
